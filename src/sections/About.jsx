      ...
      <div className="container mx-auto px-6 relative z-10">
        <div className="grid lg:grid-cols-2 gap-12 md:gap-16 items-center">
          ...
          <div className="space-y-8 text-center lg:text-left">
            ...
            <div className="space-y-4 text-muted-foreground animate-fade-in animation-delay-200 max-w-2xl mx-auto lg:mx-0 text-sm md:text-base">
              <p>
          ...
          <div className="grid sm:grid-cols-2 gap-4 md:gap-6">
            {HIGHLIGHTS.map((item, idx) => (
              <div
                key={idx}
                className="glass p-6 rounded-2xl animate-fade-in flex flex-col items-center sm:items-start text-center sm:text-left"
